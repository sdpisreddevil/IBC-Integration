...
public class ICS20Bank {
    ...
    public void setupRole(int role, Address account) {
        Context.require(Context.getCaller().equals(Context.getOwner()), TAG + ": Only owner can set up role");
    ...
    public BigInteger balanceOf(Address account, String denom) {
        Context.require(account != ZERO_ADDRESS, TAG + ": balance query for the zero address");
